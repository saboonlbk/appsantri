			...
			<div class="row text-capitalize">
				<div class="col-md-6">
						...
						<div class="col-sm-9">
							<select class="form-control select2" name="santri_id" required="">
								...
								<?php foreach ($santris as $santri): ?>
									<option value="<?= $santri->id ?>"><?= '( '.$santri->nis.') '. $santri->nama ?></option>
								<?php endforeach ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="tgl_awal" id="tgl_awal" class="form-control" required="">
						</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-sm-3 col-sm-3">tanggal awal</label>
						<div class="col-sm-9">
							<input type="text" name="tgl_akhir" id="tgl_akhir" class="form-control" required="">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="tempo"  id="tempo" class="form-control" required="" readonly="">
						</div>
					</div>
				</div>
			</div>
